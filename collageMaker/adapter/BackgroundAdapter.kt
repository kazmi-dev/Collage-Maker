...
class BackgroundAdapter(
    ...
    override fun onBindViewHolder(holder: BackgroundHolder, position: Int) {
        ...
        if (selectedindex == position) {
            holder.ll_itemframe.setBackgroundColor(mContext.resources.getColor(R.color.colorAccent, null))
        } else {
            holder.ll_itemframe.setBackgroundColor(mContext.resources.getColor(R.color.transparent, null))
        }

...
object FrameImageUtils {
    ...
    fun loadFrameImages(context: Context): ArrayList<TemplateItem> {
        ...
        try {
            ...
            if (!frameNames.isNullOrEmpty()) {
                ...
                templateItemList.sortWith { lhs, rhs ->
                    lhs.photoItemList.size - rhs.photoItemList.size
                }
            }
        } catch (e: IOException) {
            e.printStackTrace()
    ...
    private fun createTemplateItems(frameName: String): TemplateItem? {
        when (frameName) {
            ...
            "collage_11_8.png" -> {
                return com.cooptech.collagephotoeditor.collageMaker.utils.ElevenFrameImage.collage_11_8()
            }
            "collage_11_7.png" -> {
                return com.cooptech.collagephotoeditor.collageMaker.utils.ElevenFrameImage.collage_11_7()
            }
            "collage_11_6.png" -> {
                return com.cooptech.collagephotoeditor.collageMaker.utils.ElevenFrameImage.collage_11_6()
            }
            "collage_11_5.png" -> {
                return com.cooptech.collagephotoeditor.collageMaker.utils.ElevenFrameImage.collage_11_5()
            }
            "collage_11_4.png" -> {
                return com.cooptech.collagephotoeditor.collageMaker.utils.ElevenFrameImage.collage_11_4()
            }
            else -> return null
        }
    }
